    ...
    <div >
        ...
        <nav className={`${isHome? "text-orange-400": "" } w-full bg-white  z-50  h-14 md:h-18 lg:h-18 fixed  top-0 left-0`}>
           <div className=' mx-auto pr-5  md:w-[90%] lg:w-[95%] p-2 justify-between flex items-center'>
                <div> {/* Logo Section */}
                    <Link to={"/"}>
                        <img src= "/orangeLogo.webp" alt="Casted! Publications Logo" fetchPriority='high' loading='eager' decoding='async'
                ...
                <div className='hidden md:flex lg:flex'>
                    {
                        ...
                        isDashboard  ?( <button onClick={handleLogout} className='px-4 py-2 bg-orange-400 rounded-lg font-medium cursor-pointer transform transition-transform duration-300 ease-in-out  text-white'> Logout </button>) :(
