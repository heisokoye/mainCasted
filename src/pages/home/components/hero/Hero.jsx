  ...
  return (
    <div className="w-full">
        <section className='bg-[url("/room.jpg")] bg-cover w-full h-[80vh] '>
            ...
            <div className='flex md:justify-between items-center h-full relative z-10 mx-auto w-[80%]'>
                <div>
                ...
                <div className='hidden lg:flex items-center justify-center'>
                    <div className="relative w-[50rem] h-[30rem] rounded-lg shadow-2xl overflow-hidden">
                        {/* Slide Content */}
                        ...
                        {/* Left Arrow */}
                        <div className='absolute top-[50%] -translate-y-1/2 left-2 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
                            <BsArrowLeft onClick={prevSlide} size={20} classname="cursor-pointer" />
                        </div>
                        {/* Right Arrow */}
                        <div className='absolute top-[50%] -translate-y-1/2 right-2 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
                            <BsArrowRight onClick={nextSlide} size={20}  />
                        </div>
                    </div>
                </div>
            </div>
